...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA0-WKUP     ------> ADC1_IN0
    */
    GPIO_InitStruct.Pin = DRV1_IPROPI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(DRV1_IPROPI_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PA1     ------> ADC2_IN1
    */
    GPIO_InitStruct.Pin = DRV2_IPROPI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(DRV2_IPROPI_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA0-WKUP     ------> ADC1_IN0
    */
    HAL_GPIO_DeInit(DRV1_IPROPI_GPIO_Port, DRV1_IPROPI_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA1     ------> ADC2_IN1
    */
    HAL_GPIO_DeInit(DRV2_IPROPI_GPIO_Port, DRV2_IPROPI_Pin);
